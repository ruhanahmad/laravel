...
} elseif ($_instance->childHasBeenRendered('2f7mPar')) {
    $componentId = $_instance->getRenderedChildComponentId('2f7mPar');
    $componentTag = $_instance->getRenderedChildComponentTagName('2f7mPar');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2f7mPar');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('2f7mPar', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
<?php /**PATH /home/iphihbst/test.iphix.shop/resources/views/layouts/app.blade.php ENDPATH**/ ?>