...
} elseif ($_instance->childHasBeenRendered('nFpkJAH')) {
    $componentId = $_instance->getRenderedChildComponentId('nFpkJAH');
    $componentTag = $_instance->getRenderedChildComponentTagName('nFpkJAH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nFpkJAH');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('nFpkJAH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH /home/iphihbst/test.iphix.shop/cameracrew/resources/views/errors/minimal.blade.php ENDPATH**/ ?>